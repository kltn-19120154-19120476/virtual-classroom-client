...
import HeadingPresentation from "src/components/Presentation/Heading";
import MultipleChoicePresentation from "src/components/Presentation/MultipleChoice";
import ParagraphPresentation from "src/components/Presentation/Paragraph";
...
const SlideShow = () => {
    ...
    const [openInputAnonymousName, setOpenInputAnonymousName] = useState(
        !user?.name,
    );
    ...
    const PresentButton = () => (
        <Tooltip
            title={
                handle.active
                    ? "Exit full screen"
                    : "Go to full screen (press F11 instead)"
            }
        >
            <IconButton
            ...
            user?.joinedGroupIds?.includes(presentation.groupId) ? (
                <>
                    ...
                    (presentation?.ownerId === user?._id ||
                        ...
                        <FullScreen handle={handle}>
                            ...
                            >
                                ...
                                >
                                    <div className={styles.buttonWrapper}>
                                        ...
                                        <Button
                                            ...
                                            onClick={async () => {
                                                ...
                                                await updatePresentationDetail({
                                                    isPresent: false,
                                                });
                                                socket.emit(
                                                    "clientStopPresent",
                                    ...
                                    {slides[index].type ===
                                        ...
                                        <MultipleChoicePresentation
                                            ...
                                            height="60vh"
                                            options={
                                                slides[index].content.options
                                            }
                                            question={
                                                slides[index].content.question
                                            }
                                        />
                                    )}
                                    {slides[index].type === "Heading" && (
                                        <HeadingPresentation
                                            ...
                                            subHeading={
                                                slides[index].content.subHeading
                                            }
                                        />
                                    )}
                                    {slides[index].type === "Paragraph" && (
                                        <ParagraphPresentation
                                            ...
                                            paragraph={
                                                slides[index].content.paragraph
                                            }
                                        />
                                    )}
                                </Grid>
                                <Grid
                                    ...
                                    xl={4}
                                    className={
                                        styles.previewPresentationSlideCol
                                    }
                                >
                        ...
                        <FullScreen handle={handle}>
                            ...
                            <div className={styles.userVoteViewWrapper}>
                                {isAnswered ? (
                                    ...
                                    >
                                        {slides[viewIndex].type ===
                                            "Heading" && (
                                            <HeadingPresentation
                                                heading={
                                                    slides[viewIndex].content
                                                        .heading
                                                }
                                                subHeading={
                                                    slides[viewIndex].content
                        ...
                        <div className={styles.userVoteViewWrapper}>
                            <span>
                                This presentation has not been started yet.
                            </span>
                        </div>
                    )}
                    <Drawer
                            ...
                            <ul style={{ padding: 20 }}>
                                {history
                                    ...
                                    ?.map((history) => (
                                        ...
                                        >
                                            <b>{history.userName}</b> choose
                                            option <b>{history.option}</b> at{" "}
                                            <b>
                                                {new Date(
                                                    history.time,
                                                ).toLocaleTimeString()}
