...
import { createBBBClass } from "../../../client/bbb-client";
import { createInviteLinkGroup, deleteGroupById, getGroupDetail, removeFromGroup, sendInviteEmail, updateRoleInGroup } from "../../../client/group";
        ...
        <Button
          onClick={() =>
            createBBBClass({
              meetingID: group?._id,
              recordID: group?._id,
              name: `Meeting of group ${group?.name}`,
              attendeePW: "123",
              moderatorPW: "123",
